...
const showRecipe = async function() {
    try {
        ...
        if (!id) return;
        (0, _viewRecipeJsDefault.default).renderingSpinner();
        //0) update results view to mark selected search result
        (0, _resultViewJsDefault.default).update(_modelJs.receipeIntoPage());
        //update bookmarks
        (0, _viewBookmarkJsDefault.default).update(_modelJs.newState.bookmarks);
        // 1) Loading Recipe
        await _modelJs.loadRecipe(id);
        // 2) Rendering Recipe
        (0, _viewRecipeJsDefault.default).renderData(_modelJs.newState.recipeProp);
    // controlServings();
    } catch (err) {
        (0, _viewRecipeJsDefault.default).renderingError();
    }
};
const controllerSearchResult = async function() {
    try {
        ...
        if (!query) return;
        (0, _resultViewJsDefault.default).renderingSpinner();
        // console.log(ViewResult);
        // 2)load search result
        await _modelJs.searchRecipe(query);
        // 3)render results
        // ViewResult.render(model.newState.search.results);
        (0, _resultViewJsDefault.default).renderData(_modelJs.receipeIntoPage());
        //Render Initial Pagination button
        (0, _paginationViewJsDefault.default).renderData(_modelJs.newState.search);
    } catch (err) {
        console.error(err);
    }
};
...
const controlPagination = function(goToPage) {
    ...
    (0, _resultViewJsDefault.default).renderData(_modelJs.receipeIntoPage(goToPage));
...
const controlServings = function(newServing) {
    ...
    (0, _viewRecipeJsDefault.default).update(_modelJs.newState.recipeProp);
};
const controlBookmark = function() {
    //1) Add/remove bookmarks
    if (!_modelJs.newState.recipeProp.bookmarked) _modelJs.addBookMark(_modelJs.newState.recipeProp);
    else _modelJs.removeBookmark(_modelJs.newState.recipeProp.id);
    //2) update recipe
    (0, _viewRecipeJsDefault.default).update(_modelJs.newState.recipeProp);
    //3) Render bookmark
...
parcelHelpers.export(exports, "newState", ()=>newState);
parcelHelpers.export(exports, "loadRecipe", ()=>loadRecipe);
parcelHelpers.export(exports, "searchRecipe", ()=>searchRecipe);
parcelHelpers.export(exports, "receipeIntoPage", ()=>receipeIntoPage);
...
var _searchViewJs = require("../js/view/searchView.js");
const newState = {
    recipeProp: {},
    search: {
        query: "",
...
const loadRecipe = async function(id) {
    try {
        ...
        if (newState.bookmarks.some((bookmark)=>bookmark.id === id)) newState.recipeProp.bookmarked = true;
        else newState.recipeProp.bookmarked = false;
    // console.log(recipes);
    } catch (err) {
        console.error(`${err} \u{1F480}\u{1F4A5}\u{26D4}\u{26D4}`);
        throw err;
    }
};
const searchRecipe = async function(recipe) {
    try {
        newState.search.query = recipe;
        const data = await (0, _helperJs.getJSON)(`${(0, _configJs.API_URL)}?search=${recipe}`);
...
const receipeIntoPage = function(page = newState.search.page) {
...
},{"./config.js":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"blwqv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class SearchView {
...
class ViewRecipe extends (0, _viewDefault.default) {
    ...
    _errorMessage = "Invalid Recipe or Recipe not Found. Please try another!";
    _successMsg = "";
    eventRecipeRender(recipeHandler) {
        [
            "hashchange",
            "load"
        ].map((event)=>window.addEventListener(event, recipeHandler));
    }
...
`;
    ...
    _generateMarkupIngredients(ingr) {
        return `
    <li class="recipe__ingredient">
      <svg class="recipe__icon">
        <use href="${0, _iconsSvgDefault.default}#icon-check"></use>
      </svg>
      <div class="recipe__quantity">${ingr.quantity ? (0, _fractyDefault.default)(ingr.quantity) : ""} </div>
      <div class="recipe__description">
        <span class="recipe__unit">${ingr.unit ? ingr.unit : ""}</span>
        ${ingr.description}
      </div>
    </li>
    `;
...
},{"url:../../img/icons.svg":"loVOp","fracty":"hJO4d","./view":"4wVyX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"loVOp":[function(require,module,exports) {
...
},{"url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"i3HJw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class ViewResult extends (0, _viewJsDefault.default) {
    _parentEle = document.querySelector(".results");
    _errorMessage = "Recipe Not Found for your query! Please try again ;)";
    _successMsg = "";
    _generateMarkup() {
        return this._data.map((result)=>(0, _previewViewJsDefault.default).renderData(result, false)).join("");
    }
}
...
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class ViewPreview extends (0, _viewJsDefault.default) {
    _parentEle = "";
    _generateMarkup() {
        const id = window.location.hash.slice(1);
        return `
...
exports.default = new ViewPreview();
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _renderPaginationButton(num) {
        ...
        return `
    <button data-goto="${num < 1 ? currPage - 1 : currPage + 1}" class=" btn--inline  pagination__btn--${num < 1 ? "prev" : "next"}">
    <span>Page ${currPage + num}</span>
    <svg class="search__icon">
      <use href="${0, _iconsSvgDefault.default}#icon-arrow-${num < 1 ? "left" : "right"}"></use>
    </svg>
  </button>
    `;
    }
    _generateMarkup() {
        ...
        if (currPage === 1 && totalPages > 1) return this._renderPaginationButton(1);
        //Last page
        if (currPage === totalPages && totalPages > 1) return this._renderPaginationButton(-1);
        //Other page
        if (currPage < totalPages) return `${this._renderPaginationButton(1) + this._renderPaginationButton(-1)}`;
...
},{"../model.js":"Y4A21","./view.js":"4wVyX","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kfNx3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class ViewBookmark extends (0, _viewJsDefault.default) {
